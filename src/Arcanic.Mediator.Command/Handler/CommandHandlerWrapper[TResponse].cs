...
public abstract class CommandHandlerWrapper<TResponse> : CommandHandlerWrapperBase
{
    /// <summary>
    ...
    /// </returns>
    public abstract Task<TResponse> Handle(ICommand request, IServiceProvider serviceProvider,
