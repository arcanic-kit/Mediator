...
public sealed class MessageMediatorPipelineRequestHandlerStrategy<TMessage> : IMessageMediatorStrategy<TMessage, Task> where TMessage : notnull
{
    /// <summary>
    ...
    /// <returns>A task that represents the completion of the complete pipeline execution.</returns>
    ...
    /// 2. Single main handler
    /// 3. All post-handlers in parallel
