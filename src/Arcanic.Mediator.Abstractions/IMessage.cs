...
/// <summary>
/// Represents the base contract for all messages in the mediator pattern.
/// This interface serves as a marker interface to identify types that can be processed by the mediator.
/// </summary>
/// <remarks>
/// Implement this interface on your message types (commands, queries, events) to enable them
