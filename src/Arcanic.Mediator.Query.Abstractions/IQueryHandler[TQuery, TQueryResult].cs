...
/// <remarks>
/// Query handlers are automatically discovered and registered when using the <see cref="QueryModuleBuilder"/>
/// assembly scanning functionality. Each handler is registered as a scoped service in the dependency injection
